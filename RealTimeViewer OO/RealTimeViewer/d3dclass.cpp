	...
	float screenDepth, float screenNear)
{
	...
	m_projectionMatrix = XMMatrixPerspectiveFovRH(fieldOfView, screenAspect, screenNear, screenDepth);
...
{
	//Before shutting down set to windowed mode or it will throw an exception.
	if (m_swapChain)
	{
